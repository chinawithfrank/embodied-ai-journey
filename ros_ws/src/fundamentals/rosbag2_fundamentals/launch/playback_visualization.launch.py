...
def generate_launch_description():
    ...
    experiment_share = get_package_share_directory('rosbag2_fundamentals')
    urdf_path = os.path.join(robot_share, 'urdf', 'r2d2.urdf.xml')
    rviz_path = os.path.join(experiment_share, 'rviz', 'replay.rviz')
    ...
    return LaunchDescription([
        ...
        Node(
            ...
            arguments=[
                ...
                '--frame-id', 'odom', '--child-frame-id', 'axis',
            ],
        ),
        Node(
            package='tf2_ros',
